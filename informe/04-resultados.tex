...
Los resultados obtenidos a primera vista parecían todos iguales. Pero al hacerles zoom, pudimos ver que no era así. En la carpeta \textit{imagenes_extra} que adejuntamos con el código se encuentran tanto la imagen original como sus respectivos resultados.
\begin{figure}[!htb]
